...
def _generate_absence_report(self, from_date, to_date):
    ...
    try:
        ...
        # الحصول على جميع سجلات الغياب والتأخير في الفترة المحددة
        query = """
            SELECT 
                a.date,
                a.national_id,
            ...
            AND (a.status = 'غائب' OR a.status = 'متأخر' OR a.status = 'حالة وفاة')
        ...
        for i, record in enumerate(records):
            ...
            if original_status == "غائب":
                status_with_category = f"غائب - {category}"
            elif original_status == "متأخر":
                status_with_category = f"متأخر - {category}"
            elif original_status == "حالة وفاة":
                status_with_category = f"غائب - {category} (حالة وفاة)"
            else:
                status_with_category = f"{original_status} - {category}"
            ...
            if not action_taken:
                ...
                if original_status == "غائب" or original_status == "حالة وفاة":
        ...
        if export_file:
            ...
            with pd.ExcelWriter(export_file, engine='openpyxl') as writer:
                ...
                worksheet['A1'].fill = openpyxl.styles.PatternFill(start_color="D9D9D9", end_color="D9D9D9", fill_type="solid")
